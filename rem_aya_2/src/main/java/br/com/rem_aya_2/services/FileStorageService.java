...
import br.com.rem_aya_2.config.FileStorageConfig;
import br.com.rem_aya_2.exceptions.FileStorageException;
import br.com.rem_aya_2.exceptions.MyFileNotFoundException;
...
public class FileStorageService {
	...
	public String storeFile(MultipartFile file) {
		...
		try {
			...
			throw new FileStorageException("Could store file " + filename + ". Please try again.", e);
		}
	}
